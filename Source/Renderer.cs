/*
 * Original Source Code by https://github.com/mellinoe modified by Oliver Karger (https://github.com/oliverkarger)
 */
...
/// <summary>
/// Renderer for ImGui UIs
/// </summary>
internal class ImGuiRenderer : IDisposable
{
    private GraphicsDevice graphicsDevice;
    private bool frameHasBegin;
    ...
    /// </summary>
    public ImGuiRenderer(GraphicsDevice gd, OutputDescription outputDescription, Vector2 size, Action<ImGuiStylePtr, ImGuiIOPtr> InvokeStyle)
    {
        graphicsDevice = gd;
        windowSize = size;
        ImGui.CreateContext();
        ...
        InvokeStyle(ImGui.GetStyle(), ImGui.GetIO());
